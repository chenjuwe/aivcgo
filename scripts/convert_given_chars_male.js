...
// 讀取男性用字池 CSV 檔案
const csvPath = path.join(__dirname, '../data/given_chars_male_sample.csv');
const jsonPath = path.join(__dirname, '../src/utils/data/given_chars_male.json');
...
try {
  ...
  console.log(`成功轉換 ${data.length} 個男性用字到 ${jsonPath}`);
